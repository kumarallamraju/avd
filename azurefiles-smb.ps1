...
cd C:\Users\avdjoin\Downloads\AzFilesHybrid #Here avdjoin is my username
...
Join-AzStorageAccountForAuth `
        ...
        -OrganizationalUnitDistinguishedName "{full OU name here}" # If you don't provide the OU name as an input parameter, the AD identity that represents the storage account is created under the root directory.
...
$StorageAccountKey = "{copy the shared access key from azure portal}"
